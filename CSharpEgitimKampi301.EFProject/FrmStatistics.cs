...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void lblLocationCount_Click(object sender, EventArgs e)
        {
            ...
            lblAvgLocationPrice.Text=  db.Location.Average( x=> (Decimal)x.Price).ToString("0.00")+".-TL";
            ...
            lblTurkAvrCapacity.Text=db.Location.Where(x=> x.Country=="Türkiye").Average(y=> y.Capacity).ToString();
            ...
            lblAyCiTurCount.Text=db.Location.Where(x=>x.GuideId==guideIdByNameAysegulCinar).Count().ToString();
